...
// Bleh, arbitrary numbers :(
var shadow_angle = 20;

// Configure offset for x and y to position the shadow's origin
...
// Convert sprite to a texture we can pass to the shader
var shadow_sprite = sprite_get_texture(sprite, 0);
...
if(sprite != undefined)
{
    // For dynamic shadows, we'd want to designate a light source object in the room and calculate the angle based off of that.
...
//Shut down the shader, otherwise everything would be drawn solid black
shader_reset();
